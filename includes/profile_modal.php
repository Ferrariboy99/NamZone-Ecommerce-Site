        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="profile_edit.php" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="proof_res" class="col-sm-3 control-label">Proof of Residence</label>
                    <div class="col-sm-9">
                      <input type="file" id="proof_res" name="proof_res">
                    </div>
                </div>

                  <div class="form-group">
                      <label for="id_doc" class="col-sm-3 control-label">Identity Document</label>
                      <div class="col-sm-9">
